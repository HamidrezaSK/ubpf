...
struct IPv6Rule lookups[RULES_NUM] = {
    {
        // Rule 1
        .src_ip.s6_addr16 = {0x2011, 0x0db7, 0x85b3, 0x8000, 0x5021, 0x8a2e, 0x0370, 0x7334},
    },
    {
        // Rule 2
        .src_ip.s6_addr16 = {0x2001, 0x0db8, 0x85a3, 0x0700, 0x0900, 0x8a1e, 0x1370, 0x1234},
    },
    {
        // Rule 3
        .src_ip.s6_addr16 = {0x2606, 0x2800, 0x220, 0x1, 0x248, 0x1893, 0x25c8, 0x1946},
    },
    {
        // Rule 4
        .src_ip.s6_addr16 = {0x2a03, 0x2880, 0xf21a, 0x83, 0xface, 0xb00b, 0x0360, 0x25de},
    },
};
