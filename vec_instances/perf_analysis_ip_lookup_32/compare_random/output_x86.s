...
0000000000000000 <is_dst_one_one_one_one>:
      ...
      c7: 66 41 0f 76 f8               	pcmpeqd	%xmm8, %xmm7
      ...
      f0: 66 41 0f 76 e9               	pcmpeqd	%xmm9, %xmm5
      f5: 66 0f db ef                  	pand	%xmm7, %xmm5
     ...
     11d: 66 0f 76 fb                  	pcmpeqd	%xmm3, %xmm7
     ...
     144: 66 0f 76 d4                  	pcmpeqd	%xmm4, %xmm2
     148: 66 0f db d7                  	pand	%xmm7, %xmm2
     14c: 66 0f db d5                  	pand	%xmm5, %xmm2
     150: 66 0f fa c2                  	psubd	%xmm2, %xmm0
     154: 48 05 a0 00 00 00            	addq	$160, %rax
     15a: 48 3d 8c 05 00 00            	cmpq	$1420, %rax             # imm = 0x58C
     160: 0f 85 3a ff ff ff            	jne	0xa0 <is_dst_one_one_one_one+0xa0>
     166: 66 0f 70 c8 ee               	pshufd	$238, %xmm0, %xmm1      # xmm1 = xmm0[2,3,2,3]
     16b: 66 0f fe c8                  	paddd	%xmm0, %xmm1
     16f: 66 0f 70 c1 55               	pshufd	$85, %xmm1, %xmm0       # xmm0 = xmm1[1,1,1,1]
     174: 66 0f fe c1                  	paddd	%xmm1, %xmm0
     178: 66 41 0f 7e c4               	movd	%xmm0, %r12d
     17d: 41 83 c7 01                  	addl	$1, %r15d
     181: 41 83 ff 04                  	cmpl	$4, %r15d
     185: 74 10                        	je	0x197 <is_dst_one_one_one_one+0x197>
     187: 8a 45 dc                     	movb	-36(%rbp), %al
     18a: 84 c0                        	testb	%al, %al
     18c: 0f 85 9e fe ff ff            	jne	0x30 <is_dst_one_one_one_one+0x30>
     192: e9 b6 fe ff ff               	jmp	0x4d <is_dst_one_one_one_one+0x4d>
     197: 49 63 c4                     	movslq	%r12d, %rax
     19a: 48 83 c4 10                  	addq	$16, %rsp
     19e: 5b                           	popq	%rbx
     19f: 41 5c                        	popq	%r12
     1a1: 41 5e                        	popq	%r14
     1a3: 41 5f                        	popq	%r15
...
00000000000001b0 <main>:
     ...
     2f4: 66 2e 0f 1f 84 00 00 00 00 00	nopw	%cs:(%rax,%rax)
     2fe: 66 90                        	nop
     ...
     327: 66 41 0f 76 f8               	pcmpeqd	%xmm8, %xmm7
     ...
     350: 66 41 0f 76 e9               	pcmpeqd	%xmm9, %xmm5
     355: 66 0f db ef                  	pand	%xmm7, %xmm5
     ...
     37d: 66 0f 76 fb                  	pcmpeqd	%xmm3, %xmm7
     ...
     3a4: 66 0f 76 d4                  	pcmpeqd	%xmm4, %xmm2
     3a8: 66 0f db d7                  	pand	%xmm7, %xmm2
     3ac: 66 0f db d5                  	pand	%xmm5, %xmm2
     3b0: 66 0f fa c2                  	psubd	%xmm2, %xmm0
     3b4: 48 05 a0 00 00 00            	addq	$160, %rax
     3ba: 48 3d 8c 05 00 00            	cmpq	$1420, %rax             # imm = 0x58C
     3c0: 0f 85 3a ff ff ff            	jne	0x300 <main+0x150>
     3c6: 66 0f 70 c8 ee               	pshufd	$238, %xmm0, %xmm1      # xmm1 = xmm0[2,3,2,3]
     3cb: 66 0f fe c8                  	paddd	%xmm0, %xmm1
     3cf: 66 0f 70 c1 55               	pshufd	$85, %xmm1, %xmm0       # xmm0 = xmm1[1,1,1,1]
     3d4: 66 0f fe c1                  	paddd	%xmm1, %xmm0
     3d8: 66 41 0f 7e c4               	movd	%xmm0, %r12d
     3dd: 41 83 c7 01                  	addl	$1, %r15d
     3e1: 41 83 ff 04                  	cmpl	$4, %r15d
     3e5: 74 10                        	je	0x3f7 <main+0x247>
     3e7: 8a 45 dc                     	movb	-36(%rbp), %al
     3ea: 84 c0                        	testb	%al, %al
     3ec: 0f 85 9e fe ff ff            	jne	0x290 <main+0xe0>
     3f2: e9 b6 fe ff ff               	jmp	0x2ad <main+0xfd>
     3f7: 49 63 f4                     	movslq	%r12d, %rsi
     3fa: bf 00 00 00 00               	movl	$0, %edi
		00000000000003fb:  R_X86_64_32	.rodata.str1.1+0x18
     3ff: 31 c0                        	xorl	%eax, %eax
     401: e8 00 00 00 00               	callq	0x406 <main+0x256>
		0000000000000402:  R_X86_64_PLT32	printf-0x4
     406: 31 c0                        	xorl	%eax, %eax
     408: 48 83 c4 10                  	addq	$16, %rsp
     40c: 5b                           	popq	%rbx
     40d: 41 5c                        	popq	%r12
     40f: 41 5e                        	popq	%r14
     411: 41 5f                        	popq	%r15
