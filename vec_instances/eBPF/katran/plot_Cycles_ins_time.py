...
if __name__ == "__main__":
    ...
    # Subplot 1: Cycles
    axs[0].bar(x, cycles/cycles[0], width, color=colors,zorder=2)
    axs[0].set_xticks(x)
    axs[0].set_xticklabels(labels)
    ...
    # # Subplot 2: Instructions
    axs[1].bar(x, inst/inst[0], width, color=colors,zorder=2)
    axs[1].set_xticks(x)
    axs[1].set_xticklabels(labels)
    ...
    # # Subplot 3: Times
    axs[2].bar(x, times/times[0], width, color=colors,zorder=2)
    axs[2].set_xticks(x)
    axs[2].set_xticklabels(labels)
