...
#include "katran_x86/lib/linux_includes/bpf_endian.h"
...
#include "katran_x86/lib/bpf/control_data_maps.h"
#include "katran_x86/lib/bpf/encap_helpers.h"
#include "katran_x86/lib/bpf/flow_debug.h"
#include "katran_x86/lib/bpf/pckt_parsing.h"

// static int (*print_2)(const char,__u64) = (void*)10;

__attribute__((__always_inline__)) static inline int my_bpf_xdp_adjust_head(void* xdp_md, int delta)
{
...
__attribute__((__always_inline__)) static inline bool encap_v6(
  ...
  if (my_bpf_xdp_adjust_head(xdp, 0 - (int)sizeof(struct ipv6hdr))) {
    return false;
  }
